...
// ③ 足りなければ残りコーチ
// =========================
for (const coach of remainingCoaches) {

  if (capacity >= finalNeedCount) {
    break;
  }
